# This is a DERIVED TABLE - custom SQL which runs (in this case) every 24hrs and gets written to
# GBQ. We're using this as GA properties are stored in seperate datasets, but we'll want to compare
# some of their high-level metrics
# (The SQL here was mainky generated by Looker)
